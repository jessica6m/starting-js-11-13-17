...
var apollo = {
  ...
  /*This is the speak method on the apollo object, methods are functions
  that are the property of an object in JS */
  speak: function() {
...
/* With functions that use multiple parameters the order matters, supply the parameters
in the same order in which the arguments are listed where the function is defined
*/

apollo.sayHiTo("Stella", 5);

/*The console object is a global object created within the browser, log is a method on
that object */
console.log(console);
